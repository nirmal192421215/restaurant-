            ...
            <div className="max-w-md mx-auto mb-6">
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white border border-[var(--color-brand-beige)] rounded-2xl py-3 pl-12 pr-4 text-sm text-[var(--color-brand-charcoal)] focus:outline-none focus:ring-2 focus:ring-[var(--color-brand-orange)]/20 transition-all shadow-sm"
                />
